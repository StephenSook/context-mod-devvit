...
const baseItem: Item = {
  id: 't3_a', title: 'hi', body: '', url: 'https://example.com', author: 'u',
  age: 1000, score: 5, isSelf: false, over18: false, removed: false,
  approved: false, locked: false, stickied: false, linkFlairText: null,
};

const baseAuthor: Author = {
  name: 'u', id: 't2_z', age: 86400, linkKarma: 100, commentKarma: 200,
...
describe('passesFilters — itemIs predicates', () => {
  ...
  it('linkFlairTextIn rejects null link flair', () => {
    expect(passesFilters({ itemIs: { linkFlairTextIn: ['News'] } }, baseItem, baseAuthor)).toBe(false);
  });
});

...
**App version:** v0.6.7 (npm/source). Devvit cm-devvit@0.2.4 approved unlisted 2026-05-18 (installable today) + cm-devvit@0.2.6 (v0.6.7 source) submitted for App Directory re-review 2026-05-19 (`npm run launch` shipped T-8, 6 days early). Phase 1 + 2 + 3 + 4 + 4.7 ALL SHIPPED. 828 tests green.

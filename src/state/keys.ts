...
export const K = {
  ...
  // Atomic INCR counter for rev allocation — closes the read-modify-write
  // race in publish() where two concurrent writers could both pick the same
  // N+1 and silently last-writer-wins.
